...
/* enums */
enum { SchemeNorm, SchemeSel, SchemeOut, SchemeBackground, SchemeSidebar, SchemePrompt, SchemeInput, SchemeBorders, SchemeNormHighlight, SchemeSelHighlight, SchemeLast }; /* color schemes */
...
setup(void)
{
	...
	XSetWindowBorder(dpy, win, scheme[SchemeBorders][ColBg].pixel);
